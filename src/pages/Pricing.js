...
const Pricing = () => {
	return (
		<div>
			<section className="text-gray-600 m-auto w-1260 body-font">
				<div className="container py-24 mx-auto">
					...
					<div className="flex pl-4 mt-4 w-full mx-auto">
						<Link className="text-indigo-500 cursor-pointer inline-flex items-center md:mb-2 lg:mb-0">Learn More
